...
public class AtualizacaoCodigo {
    public static void main(String[] args) {
        ...
        switch (opcao) {
            case 1:
                nomeScript = baseDiretorio + "ForcaAtualizacaoWindows.ps1";
                try {
                    ProcessBuilder pb = new ProcessBuilder("powershell", "-ExecutionPolicy", "Bypass","-File", nomeScript);
                ...
                break;
            case 2:
                nomeScript = baseDiretorio + "ResetWindowsUpdate.ps1";
                try {
                    ProcessBuilder pb = new ProcessBuilder("C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe", "-ExecutionPolicy", "Bypass","-File", nomeScript);
                    pb.redirectErrorStream(true);
                    Process processo = pb.start();
                    BufferedReader leLinha = new BufferedReader(new InputStreamReader(processo.getInputStream()));
                    StringBuilder linhaLida = new StringBuilder();
